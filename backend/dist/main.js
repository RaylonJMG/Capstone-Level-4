...
function home(request, response) {
  var url = request.url;
  response.send("<h1>Home</h1><p>The path to the home page is ".concat(url, "</p>"));
}
...
function root(request, response) {
  var url = request.url;
  response.send("<h1>Good Food Hut!</h1><p>Welcome to the backend. The path is ".concat(url, "!</p>"));
}
